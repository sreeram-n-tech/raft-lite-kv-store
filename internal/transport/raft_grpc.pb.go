...
const (
	Raft_RequestVote_FullMethodName   = "/transport.Raft/RequestVote"
	Raft_AppendEntries_FullMethodName = "/transport.Raft/AppendEntries"
)
...
var Raft_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/transport/raft.proto",
}
